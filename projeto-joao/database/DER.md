...
Uma máquina realiza nenhuma ou várias produções. Cada produção pertence a exatamente uma máquina. Sustentabilidade e ocorrências são registros independentes nesta etapa.
